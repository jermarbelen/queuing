...
<!-- header area -->
    <header class="wrapper clearfix">
        ...
        <div id="banner">        
        	<div id="logo"><a href="#"><img src="images/colorblocks-logo.svg" alt="logo"></a></div> 
        </div>
        ...
        <div class="menu-toggle">Menu</div>  
            ...
            <li class="current">
            <!--<li><a href="colorblocks-internal.html">Internal page demo</a></li>
...
<!-- hero area (the grey one with a slider -->
    ...
    <div class="wrapper">
      <h1>Success!</h1>
      <p>Please wait for you name or number to be called.</p>
      <p><a href="index.php">Another Transaction</a></p>
    </div>
...
<footer>
    ...
    <!--You can NOT remove this attribution statement from any page, unless you get the permission from prowebdesign.ro--><div id="attribution" class="wrapper clearfix" style="color:#666; font-size:11px;">Site built by <a href="#" target="_blank" title="Queuing System Template is a free software by www.prowebdesign.ro" style="color:#777;">DENR-MIMAROPA</a></div><!--end attribution-->
