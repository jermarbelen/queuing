...
$query_rstransactions = "SELECT * FROM trasaction_tb WHERE called_status ='N' OR called_status ='T' AND counter = '" . $_GET['counter'] . "' ORDER BY transaction_id ASC";
...
<meta http-equiv="refresh" content="30;URL='list_transactions_ongoing.php'" />
